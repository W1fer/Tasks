<?php
	...
	// ФИО
	const N_S_PISREQUIRED = true;
	const MSGSNAMEERROR = "⚠ Поле обязательно для заполнения";

	// Адрес
	const ADDRESSISREQUIRED = false;
	const MSGSADDRESSERROR = "⚠ Поле обязательно для заполнения";

	// Email
	const EMAILISREQUIRED = false;
	const MSGSEMAILERROR = "⚠ Поле обязательно для заполнения";
	const MSGSEMAILINCORRECT = "Почтовые адреса введён верно";
	const MSGEMAILBLOCKED="Почтовый адрес @gmail.com не поддерживается "
